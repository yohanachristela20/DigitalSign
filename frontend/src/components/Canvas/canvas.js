...
// Draft set positioning Field
// (-filter page -- only show field pada pageNum = page dari db)
...
//     // console.log("CURRENT PAGE PDFCANVAS:", currentPage);
...
//     // console.log("CURRENT PAGE PDFCANVAS:", pageCurrent);
...
//     // console.log("x_axis, y_axis, width, height, jenis_item, page:", x_axis, y_axis, width, height, jenis_item, page)
...
//     // console.log("signatures from canvas:", signatures);
...
//             // console.log("Render page container:", pageNumber);
//             // console.log("PDFCanvas: signatures prop:", signatures);
//             // console.log("PDFCanvas: type and length:", Array.isArray(signatures), signatures?.length);
...
//                 {initials
//                   .filter(sig => {
//                     console.log("pageCurrent di signatures:", pageCurrent);
//                     const fieldPage = Number(pageCurrent ?? sig.page ?? pageNumber);
